    ...
    <div className="space-y-4">
      ...
      <div className="space-y-2">
        <textarea
          ...
          className="w-full bg-white border border-slate-300 rounded p-4 text-sm text-slate-900 font-medium focus:outline-none focus:border-ntms-blue resize-none leading-relaxed shadow-sm"
        />

        <div className="flex justify-between items-center text-xs font-mono font-bold text-slate-700 px-1">
          <span>Word Count: <strong className="text-ntms-navy">{wordsCount}</strong> words</span>
